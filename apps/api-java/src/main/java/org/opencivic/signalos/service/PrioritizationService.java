...
public interface PrioritizationService {
    ...
    Signal createSignal(String title, String description, String category, int urgency, int impact, int affectedPeople, String imageUrl, Double latitude, Double longitude, String username);
    Signal createSignal(String title, String description, String category, int urgency, int impact, int affectedPeople, String imageUrl, Double latitude, Double longitude, String username, UUID communityId);
