...
public class MockSignalRepository implements SignalRepository {
    ...
    public List<Signal> findAll() {
        return List.of(
            ...
            new Signal(UUID.randomUUID(), "Pothole in Main Ave", "Large pothole causing traffic issues", "infrastructure", 3, 5, 2000, 150, 0.0, null, "IN_PROGRESS", LocalDateTime.now().minusDays(1)),
            ...
            new Signal(UUID.randomUUID(), "Noise Complaint - Night Club", "Excessive noise after midnight", "safety", 4, 3, 100, 45, 0.0, null, "RESOLVED", LocalDateTime.now().minusDays(3))
        );
    }
}
