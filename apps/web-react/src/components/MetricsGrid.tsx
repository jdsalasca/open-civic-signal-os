...
export function MetricsGrid({ signals }: Props) {
  ...
  const metrics = useMemo(() => {
    ...
    return [
      { id: 'total', title: t('metrics.total'), value: String(total), icon: "pi-list", color: "text-cyan-400", border: "" },
      { id: 'new', title: t('metrics.new'), value: String(newlyReported), icon: "pi-plus-circle", color: "text-blue-400", border: "blue" },
      { id: 'analysis', title: t('metrics.analysis'), value: String(inProgress), icon: "pi-spin pi-cog", color: "text-orange-400", border: "orange" },
      { id: 'avg', title: t('metrics.avg'), value: avgScore, icon: "pi-chart-bar", color: "text-green-400", border: "green" },
    ];
  }, [signals, t]);
