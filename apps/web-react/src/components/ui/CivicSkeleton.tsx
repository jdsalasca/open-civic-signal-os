        ...
        {items.map((_, i) => (
          <div key={i} className="col-12 md:col-6 lg:col-4">
            <div className="glass-panel p-5 border-round-3xl overflow-hidden relative">
              ...
              <Skeleton width="30%" height="1rem" className="mb-4 bg-surface-soft" />
              <Skeleton width="100%" height="2rem" className="mb-2 bg-surface-soft" />
              <Skeleton width="80%" height="1.5rem" className="mb-6 bg-surface-soft" />
              <div className="flex justify-content-between">
                <Skeleton width="40%" height="2.5rem" borderRadius="12px" className="bg-surface-soft" />
                <Skeleton shape="circle" size="2.5rem" className="bg-surface-soft" />
              </div>
            </div>
          </div>
        ))}
          ...
          <div key={i} className="col-12 md:col-3">
            <div className="glass-panel p-4 border-round-2xl flex justify-content-between align-items-center overflow-hidden relative">
              ...
              <div className="flex flex-column gap-2 w-full">
                <Skeleton width="40%" height="0.75rem" className="bg-surface-soft" />
                <Skeleton width="60%" height="2.5rem" className="bg-surface-soft" />
              </div>
              <Skeleton shape="circle" size="3.5rem" className="bg-surface-soft" />
            </div>
          </div>
        ))}
      </div>
    ...
    <div className={classNames("flex flex-column gap-3", className)}>
      {items.map((_, i) => (
        <div key={i} className="relative overflow-hidden border-round-xl">
          ...
          <Skeleton width="100%" height="3.5rem" borderRadius="12px" className="bg-surface-soft" />
        </div>
      ))}
    </div>
  );
